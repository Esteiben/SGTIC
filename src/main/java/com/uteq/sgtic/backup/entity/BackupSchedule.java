...
public class BackupSchedule {
    ...
    @Enumerated(EnumType.STRING) @Column(name = "backup_type", nullable = false, length = 30) private BackupType backupType;
    @Enumerated(EnumType.STRING) @Column(nullable = false, length = 30) private BackupFrequency frequency;
    @Enumerated(EnumType.STRING) @Column(name = "day_of_week", length = 20) private BackupDayOfWeek dayOfWeek;
    @Column(name = "execution_time", nullable = false) private LocalTime executionTime;
    @Column(nullable = false) private Boolean active;
    @Column(name = "windows_task_name", length = 200, unique = true) private String windowsTaskName;
    @Column(name = "last_sync_message", columnDefinition = "TEXT") private String lastSyncMessage;
